...
files = [ #'ExoDiBosonAnalysis.Bulkv8TeV.M-800.Beta0.root',
          #'ExoDiBosonAnalysis.Bulkv8TeV.M-800.BetaM1.root',
          'ExoDiBosonAnalysis.Bulkv8TeV.M-800.BetaP1.root',
         # 'ExoDiBosonAnalysis.Bulk2TeV.M-2000.Beta0.root',
          # 'VV/HP/SD/ExoDiBosonAnalysis.BulkWW.M-2000.root',
          # 'ExoDiBosonAnalysis.Bulk2TeV.M-2000.BetaM1.root',
          'ExoDiBosonAnalysis.Bulk2TeV.M-2000.BetaP1.root',
          
          #'ExoDiBosonAnalysis.Bulk4TeV.M-4000.Beta0.root',
          #'ExoDiBosonAnalysis.Bulk4TeV.M-4000.BetaM1.root',
          'ExoDiBosonAnalysis.Bulk4TeV.M-4000.BetaP1.root',
          ]
...
legendname = ['0.8 TeV','2.0 TeV','4.0 TeV']
...
for j in xrange(0,len(histos)):
  ...
  print 'Integral 110-135 = %f' %histos[j].Integral(histos[j].FindBin(110.),histos[j].FindBin(135.))
...
l1.DrawLatex(0.60,0.89, "G_{Bulk}#rightarrowWW") # {#scriptstyle(X=G_{Bulk}/G_{RS}/W')}
l1.SetTextSize(0.025)
l1.DrawLatex(0.60,0.84, "Softdrop (#beta = 1) AK8")
